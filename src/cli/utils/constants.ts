...
// Template choices for example command only
export const EXAMPLE_TEMPLATE_CHOICES: TemplateChoice[] = [
  {
    name: "Basic - Quick start with default settings",
    value: "basic",
    short: "Basic",
  },
  {
    name: "Demo - Complete example with sample content",
    value: "demo",
    short: "Demo",
  },
];
